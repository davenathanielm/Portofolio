...
const MyProjects =[
...

   {
    ...
    },
    {
        ...
        img :showcaseLithium,
        description :[
            "Astra Lithium Component System is a web-based platform developed to manage and monitor lithium battery components used within Astra’s operations. As the full-stack developer, I handled both frontend and backend development using PHP, CodeIgniter 4, and SQL Server.",
